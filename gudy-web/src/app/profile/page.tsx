  ...
  const settingsItems = [
    {
      ...
      subtitle: `${progress.dailyGoal} materi per hari`,
      color: '#4E9A70',
    ...
    },
    {
      ...
      subtitle: 'Hapus dan mulai dari awal',
      color: '#D9534F',
    ...
    <main className="min-h-screen bg-background pb-24 lg:pb-12 lg:pl-64 transition-colors duration-200">
      <div className="max-w-2xl mx-auto px-4 lg:px-8 pt-8">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-surface-elevated rounded-xl p-3.5 text-center border border-border">
              ...
              <p className="text-[10px] text-text-muted uppercase tracking-wider">Materi</p>
            </div>
            <div className="bg-surface-elevated rounded-xl p-3.5 text-center border border-border">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h3 className="font-semibold text-text-primary text-sm mb-3">Pengaturan Akun</h3>
        ...
        >
          <h3 className="font-semibold text-text-primary text-sm mb-3">Tentang Aplikasi</h3>
      ...
      <AnimatePresence>
        {showDailyGoal && (
          ...
          >
            ...
            >
              <h3 className="text-base font-bold text-text-primary mb-3">Target Belajar Harian</h3>
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-text-secondary mb-5 leading-relaxed">
                Tindakan ini akan mengosongkan riwayat belajar dan checklist yang telah selesai.
              </p>
