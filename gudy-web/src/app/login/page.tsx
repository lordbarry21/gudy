                      ...
                      <div className="pb-3">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 pr-3 py-2 bg-surface-elevated rounded-lg text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all"
                          />
                        </div>
                      </div>
                    </motion.div>
