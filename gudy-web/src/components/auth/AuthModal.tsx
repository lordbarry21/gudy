          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-surface-elevated border border-border text-text-primary font-medium text-sm hover:bg-surface hover:border-accent/30 transition-all disabled:opacity-50"
              >
